...
WorkDSH is an open-source AI workspace built on the official NexusOne. Organize conversations, material and capabilities in projects, reuse your local Library, and review editable deliverables alongside the task.

**v0.1.0-alpha.8 · NexusOne 0.1.7-alpha.1 · Alpha preview**

[Download](https://github.com/techflag/workdsh/releases/tag/v0.1.0-alpha.8) · [Release notes](docs/releases/v0.1.0-alpha.8.md) · [Quick start](#quick-start) · [Website](https://techflag.github.io/workdsh/) · [Gitee mirror](https://gitee.com/techflag/workdsh)
