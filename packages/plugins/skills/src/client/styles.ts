...
.skill-detail-dialog .rename-row input{flex:1;min-width:0;min-height:38px;padding:7px 12px;border:1px solid var(--dsw-alias-border-l2);border-radius:9px;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font-size:16px;font-weight:600}
.skill-detail-dialog .rename-row .save{background:var(--dsw-alias-button-primary-fill);border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary-inverted);font-weight:600}
.skill-detail-dialog .detail-title .rename-hint{margin:0 0 12px;font-size:12px;line-height:19px;color:var(--dsw-alias-label-tertiary)}
